    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-500 {{ request()->is('dashboard') ? 'text-gray-800 dark:text-gray-200' : '' }}" href="/dashboard">
            ...
            @if (Auth::check() && Auth::user()->is_admin === 1)
                <li class="relative px-6 py-3">
                    ...
                    <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                    @endif
                    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-500 {{ request()->is('users', 'users/*') ? 'text-gray-800 dark:text-gray-200' : '' }}" href="/users">
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('items.index', 'items.edit', 'items.create'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-500 {{ request()->routeIs('items.index', 'items.edit', 'items.create') ? 'text-gray-800 dark:text-gray-200' : '' }}" href="/items">
                    <svg class="w-5 h-5" data-slot="icon" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
