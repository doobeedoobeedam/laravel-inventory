<x-layout>
    ...
    <div class="w-full flex items-center justify-between my-6">
        ...
        <a href="/items/outgoing" class="px-3 py-2 text-xs font-medium transition-colors duration-150 text-teal-500 bg-white border dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 rounded-md cursor-pointer">
            Back
        </a>
    </div>
